...
//         &self,
//         endpoint: String,
//         #[napi(ts_arg_type = "Record<string, unknown>")] opts: Option<JsValue>,
//     ) -> Result<()> {
...
//     pub async fn yuse(
//         &self,
//         #[napi(ts_arg_type = "{ namespace?: string; database?: string }")] value: JsValue,
//     ) -> Result<()> {
//         let opts: opt::yuse::Use = serde_json::from_value(value)?;
//         match (opts.namespace, opts.database) {
//             (Some(namespace), Some(database)) => self
//                 .db
//                 .use_ns(namespace)
//                 .use_db(database)
//                 .await
...
//         &self,
//         key: String,
//         #[napi(ts_arg_type = "unknown")] value: JsValue,
//     ) -> Result<()> {
...
//         &self,
//         #[napi(
//             ts_arg_type = "{ namespace: string; database: string; scope: string; [k: string]: unknown }"
//         )]
//         credentials: JsValue,
//     ) -> Result<JsValue> {
...
//         &self,
//         #[napi(
//             ts_arg_type = "{ username: string; password: string } | { namespace: string; username: string; password: string } | { namespace: string; database: string; username: string; password: string } | { namespace: string; database: string; scope: string; [k: string]: unknown }"
//         )]
//         credentials: JsValue,
//     ) -> Result<JsValue> {
...
//                 password,
//             }),
//             Credentials::Root { username, password } => self.db.signin(Root { username, password }),
//         };
...
//         &self,
//         sql: String,
//         #[napi(ts_arg_type = "Record<string, unknown>")] bindings: Option<JsValue>,
//     ) -> Result<JsValue> {
...
//         &self,
//         resource: String,
//         #[napi(ts_arg_type = "Record<string, unknown>")] data: Option<JsValue>,
//     ) -> Result<JsValue> {
...
//         &self,
//         resource: String,
//         #[napi(ts_arg_type = "Record<string, unknown>")] data: JsValue,
//     ) -> Result<JsValue> {
//         let update = match resource.parse::<Range>() {
//             Ok(range) => self
//                 .db
...
//         &self,
//         resource: String,
//         #[napi(ts_arg_type = "unknown[]")] data: JsValue,
//     ) -> Result<JsValue> {
