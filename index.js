...
switch (platform) {
        ...
        switch (arch) {
            case "arm64":
                localFileExisted = existsSync(
                    join(__dirname, "@surrealdb/node.android-arm64.node"),
                );
                try {
                    if (localFileExisted) {
            ...
            case "arm":
                localFileExisted = existsSync(
                    join(__dirname, "@surrealdb/node.android-arm-eabi.node"),
                );
                try {
                    if (localFileExisted) {
    ...
    case "darwin":
        localFileExisted = existsSync(
            join(__dirname, "@surrealdb/node.darwin-universal.node"),
        );
        try {
            if (localFileExisted) {
        ...
        switch (arch) {
            case "x64":
                localFileExisted = existsSync(
                    join(__dirname, "@surrealdb/node.darwin-x64.node"),
                );
                try {
                    if (localFileExisted) {
    ...
    case "freebsd":
        ...
        localFileExisted = existsSync(
            join(__dirname, "@surrealdb/node.freebsd-x64.node"),
        );
        try {
            if (localFileExisted) {
            ...
            case "arm64":
                if (isMusl()) {
                    localFileExisted = existsSync(
                        join(
                            __dirname,
                            "@surrealdb/node.linux-arm64-musl.node",
                        ),
                    );
                    try {
                        if (localFileExisted) {
            ...
            case "arm":
                if (isMusl()) {
                    localFileExisted = existsSync(
                        join(
                            __dirname,
                            "@surrealdb/node.linux-arm-musleabihf.node",
                        ),
                    );
                    try {
                        if (localFileExisted) {
                    ...
                    localFileExisted = existsSync(
                        join(
                            __dirname,
                            "@surrealdb/node.linux-arm-gnueabihf.node",
                        ),
                    );
                    try {
                        if (localFileExisted) {
            ...
            case "riscv64":
                if (isMusl()) {
                    localFileExisted = existsSync(
                        join(
                            __dirname,
                            "@surrealdb/node.linux-riscv64-musl.node",
                        ),
                    );
                    try {
                        if (localFileExisted) {
                    ...
                    localFileExisted = existsSync(
                        join(
                            __dirname,
                            "@surrealdb/node.linux-riscv64-gnu.node",
                        ),
                    );
                    try {
                        if (localFileExisted) {
